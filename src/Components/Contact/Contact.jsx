...
const Contact = () => {
    return (
        <div data-aos="fade-right"data-aos-offset="300"data-aos-easing="ease-in-sine" className="grid max-w-screen-xl  shadow-lg hover:shadow-blue-500/50  grid-cols-1 gap-8 px-8 py-16 mx-auto my-12	 rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-transparent text-slate-50">
