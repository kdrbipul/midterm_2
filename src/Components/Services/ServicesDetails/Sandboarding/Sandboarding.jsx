            ...
            <section data-aos="zoom-in" data-aos-duration="3000" className="container mx-auto my-16 bg-gray-800 text-gray-100">
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                        ...
                        <p className="mt-6 mb-8 text-lg sm:mb-12">Experience the thrill of sandboarding, a unique adventure that combines the rush of snowboarding with the stunning backdrop of towering sand dunes. Whether you're a seasoned rider or trying it for the first time, our guided sandboarding tours promise an exhilarating experience in the heart of the desert.
