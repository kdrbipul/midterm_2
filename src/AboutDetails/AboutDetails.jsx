    ...
    return (
        <>
            <section className="container mx-auto my-8 bg-transparent text-gray-100">
                    <h1 className="text-2xl text-center	 font-bold leadi sm:text-4xl">ABOUT ME</h1>
                    <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                        <div className="flex items-center justify-center rounded p-6 mt-8 lg:mt-0 h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">
                            <img src={picture} alt="" className="object-contain rounded-lg h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" />
                        </div>
                        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                            <h1 className="text-2xl font-bold leadi sm:text-4xl">Hi! I'm a 
                            ...
                            <p className="mt-6 mb-8 text-lg sm:mb-12">That's great to hear! With your extensive experience in web design and development, you likely have a wealth of knowledge and skills in creating effective and user-friendly websites. 
                                ...
                                <br className="hidden md:inline lg:hidden"/>
                                And I'm Fully compatible with Angular, Gatsby, Plain HTML, Next.js, React, Svelte, Vue.js
                                <br className="hidden md:inline lg:hidden"/>
                                <br className="hidden md:inline lg:hidden"/>
                                <div className='my-6 flex justify-center items-center'>
                                    <span className='text-4xl text-yellow-500 inline-block'><SiAngularjs /></span>
                                    <span className='text-4xl text-yellow-500 inline-block mx-2'><RiGatsbyLine /></span>
                                    <span className='text-4xl text-yellow-500 inline-block'><ImHtmlFive2 /></span>
                                    <span className='text-4xl text-yellow-500 inline-block mx-2'><BiLogoVuejs /></span>
                                    <span className='text-4xl text-yellow-500 inline-block'><SiReact /></span>
                                    <span className='text-4xl text-yellow-500 inline-block mx-2'><SiSvelte /></span>
                                    <span className='text-4xl text-yellow-500 inline-block'><FaPython /></span>
                                </div>
                                
                            </p>
                        </div>
                    </div>
                    <section className="bg-transparent mb-9 text-gray-100">
	<div className="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
		<h2 className="text-3xl font-bold">Fully compatible with</h2>
		<div className="flex flex-wrap justify-center lg:justify-between">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Angular" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Angular</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Gatsby" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Gatsby</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Plain HTML" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Next.js" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Next.js</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Nuxt.js" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Nuxt.js</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="React" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>React</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Svelte" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Svelte</title>
			...
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Vue.js" className="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 text-yellow-500	">
				<title>Vue.js</title>
