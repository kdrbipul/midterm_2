  ...
  function myFunction() {
    ...
    <div className="w-full max-w-md p-4 my-32 rounded-md shadow sm:p-8 bg-blue-950 text-slate-50	container mx-auto">
        ...
        <div className="my-6 space-y-4">
          ...
          <button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ri focus:ri border-gray-400 focus:ri bg-red-500 hover:bg-red-700 transition">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
